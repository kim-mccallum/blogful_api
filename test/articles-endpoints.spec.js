...
describe.only(`Articles endpoints`, function() {
    ...
    describe(`GET /api/articles`, () => {
        ...
        //context for xss attack here - I had to look at the solution for this. Get some help
        ...
        describe('POST /api/articles', () => {
            it(`Creates an article, responding with 201 and the new article`, function() {
                ...
                const newArticle = {
                    ...
                    style:'Listicle',
                    content:'Test new article content... Lorem ullamco eiusmod cupidatat dolor consequat duis sit et incididunt reprehenderit commodo consequat.'
                }
                return supertest(app)
                    .post('/api/articles')
                    .send(newArticle)
